...
data = read.csv("/home/jmartin/Documents/articulo/scripts/inputs/input_FIG5A1.csv", header = TRUE, sep = "\t", encoding = "ASCII")
...
data = read.csv("/home/jmartin/Documents/articulo/scripts/inputs/input_FIG5A2.csv", header = TRUE, sep = ";", encoding = "ASCII")
...
svg(file="/home/jmartin/Documents/articulo/scripts/figuras/FIG5A2.svg", width = 15, height = 10)
...
tmb_plasma <- read_delim("/home/jmartin/Documents/articulo/scripts/inputs/input_Ext_Data_FIG8A.csv", 
...
svg(file="/home/jmartin/Documents/articulo/scripts/figuras/Ext_Data_FIG8B.svg", width = 10, height = 8)
...
tmb_tejido <- read_delim("/home/jmartin/Documents/articulo/scripts/inputs/input_Ext_Data_FIG8B.csv", 
                         delim = "\t", escape_double = FALSE, 
                         trim_ws = TRUE)
...
svg(file="/home/jmartin/Documents/articulo/scripts/figuras/Ext_Data_FIG8A.svg", width = 10, height = 8)
...
tmb_plasma <- read_delim("/home/jmartin/Documents/articulo/scripts/inputs/input_Ext_Data_FIG8C.csv", 
                         delim = "\t", escape_double = FALSE, 
                         trim_ws = TRUE)
...
svg(file="/home/jmartin/Documents/articulo/scripts/figuras/Ext_Data_FIG8C.svg", width = 10, height = 8)
p <- ggpaired(tmb_plasma_long, x = "condition", y = "value",
              color = "condition", line.color = "gray", line.size = 0.4)+
  scale_color_manual(values=c("#3C5488FF", "#E64B35FF")) +
  stat_compare_means(paired = TRUE, method = "wilcox.test",
...
data = read.csv("/home/jmartin/Documents/articulo/scripts/inputs/input_Ext_Data_FIG8D.csv", header = TRUE, sep = "\t", encoding = "ASCII")

svg(file="/home/jmartin/Documents/articulo/scripts/figuras/Ext_Data_FIG8D.svg", width = 15, height = 10)
ggplot(data, aes(x=TMB, y=dN.dS, shape=SAMPLE_TYPE, color = SAMPLE_TYPE))  +
  geom_point() +
  theme(legend.position="top")  + geom_smooth(method = lm, fill = "grey80") + 
