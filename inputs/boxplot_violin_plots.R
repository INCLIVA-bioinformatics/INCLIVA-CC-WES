...
vafs <- read.csv2("/home/jmartin/Documents/articulo/scripts/inputs/input_FIG3B.csv", header =T, dec='.', sep='\t')
#vafs$
...
vafs <- read.csv2("/home/jmartin/Documents/articulo/scripts/inputs/input_FIG3C.csv", header =T, dec='.', sep='\t')
#vafs$
...
vafs <- read.csv2("/home/jmartin/Documents/articulo/scripts/inputs/input_Ext_Data_Fig1A.txt", header =T, dec='.', sep='\t')

vafs$PORC = vafs$PORC*100

svg(file="/home/jmartin/Documents/articulo/scripts/figuras/Ext_Data_FIG1A.svg", width = 14, height = 10)
p <- ggplot(vafs, aes(x=TIPO, y=PORC, color=TIPO)) + 
...
vafs <- read.csv2("/home/jmartin/Documents/articulo/scripts/inputs/input_Ext_Data_FIG5B.csv", header =T, dec='.', sep='\t')
#vafs$
...
svg(file="/home/jmartin/Documents/articulo/scripts/figuras/Ext_Data_FIG5B.svg", width = 16, height = 10)
p <- ggplot(vafs, aes(x=TIPO, y=PORC, color=TIPO, )) + 
  geom_violin() + stat_summary(fun.data=data_summary) + theme_bw() + ylim(0,100) + 
  stat_compare_means( aes(label = ..p.signif..), method = "wilcox.test", paired = TRUE, label.x = 1.5, label.y = 100) +
  geom_line(aes(group = ID), color = "grey") + scale_color_manual(values=c("#3C5488FF", "#E64B35FF")) + ylab("% of concordance") + 
...
vafs <- read.csv2("/home/jmartin/Documents/articulo/scripts/inputs/input_Ext_Data_FIG3.csv", header =T, dec='.', sep='\t')


svg(file="/home/jmartin/Documents/articulo/scripts/figuras/Ext_Data_FIG3.svg", width = 11, height = 10)
...
vafs <- read.csv2("/home/jmartin/Documents/articulo/scripts/inputs/input_Ext_Data_FIG10A.txt", header =T, dec='.', sep='\t')
...
svg(file="/home/jmartin/Documents/articulo/scripts/figuras/Ext_Data_FIG10A.svg", width = 13, height = 10)
...
vafs <- read.csv2("/home/jmartin/Documents/articulo/scripts/inputs/input_Ext_Data_FIG10B.txt", header =T, dec='.', sep='\t')
...
svg(file="/home/jmartin/Documents/articulo/scripts/figuras/Ext_Data_FIG10B.svg", width = 13, height = 10)
...
vafs <- read.csv2("/home/jmartin/Documents/articulo/scripts/inputs/input_Ext_Data_FIG10C.txt", header =T, dec='.', sep=';')
...
svg(file="/home/jmartin/Documents/articulo/scripts/figuras/Ext_Data_FIG10C.svg", width = 14, height = 10)
